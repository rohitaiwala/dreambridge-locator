  ...
  return (
    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Courses Stat */}
        <div className="bg-amber-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm flex items-center gap-3">
          <div className="bg-amber-100 dark:bg-amber-900 p-3 rounded-full">
            <BookOpen className="h-6 w-6 text-amber-600 dark:text-amber-200" />
          </div>
        ...
        {/* Messages Stat */}
        <div className="bg-green-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm flex items-center gap-3">
        ...
        <div className="bg-purple-50 dark:bg-gray-800 p-4 rounded-lg shadow-sm flex items-center gap-3">
      ...
      <div className="mt-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
          <div className="bg-gradient-to-r from-amber-400 to-orange-500 h-2.5 rounded-full" style={{width: '70%'}}></div>
        </div>
      </div>
    </div>
  );
