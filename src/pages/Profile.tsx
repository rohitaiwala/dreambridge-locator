...
const Profile = () => {
  ...
  const renderSectionHeader = (title: string, isEditingSection: boolean, setIsEditingSection: (value: boolean) => void) => (
            ...
            <Card className="shadow-lg border-2 border-amber-300 bg-[#FDE1D3]/80 dark:bg-gray-800 mb-6">
              <CardHeader>
                <ProfileHeader
                  ...
                  onEdit={() => setIsEditingHeader(!isEditingHeader)}
              ...
              <CardContent className="pt-6 space-y-6">
                ...
                {user.role === 'tutor' && (
                  <ProfileRatings user={user} isEditing={false} />
                )}
              </CardContent>
              
              <CardFooter>
                <div className="flex justify-end gap-4 pt-4">
                  {(isEditingHeader || isEditingAbout || isEditingStats || isEditingLocation || 
                   isEditingSocial || isEditingSkills || isEditingLearningTime || 
                   isEditingCourses || isEditingTeachingHistory || isEditingContact) ? (
                    <Button 
                      variant="default" 
